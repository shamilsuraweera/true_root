...
class _AdminBatchesPageState extends ConsumerState<AdminBatchesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return AdminPageShell(
      title: 'Audit batches',
      subtitle: 'Inspect batch records, statuses, and historical movement.',
      ...
      actions: [
        AdminHeaderIconButton(icon: Icons.refresh, onPressed: _refresh),
      ],
            ...
            batchesAsync.when(
              data: (batches) {
                ...
                final filtered = batches
                    .where((batch) => _matches(batch, query))
                    .toList();
                if (filtered.isEmpty) {
